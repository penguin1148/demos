...
export const CHOICE_EVENTS = [
  { id: "wanderers", icon: "🚶", name: "Wandering Folk at the Gate",
    ...
    a: { label: "Take them in (−12 grain)", cost: { grain: 12 }, gain: { population: 10 }, log: "The wanderers are taken in; ten souls join the Demos." },
  ...
  { id: "oracle", icon: "🔮", name: "A Wandering Seer",
    ...
    a: { label: "Pay the seer (−3 cattle)", cost: { cattle: 3 }, gain: { piety: 10, muthos: 8 }, log: "The seer's words steady the people; Piety and lore grow." },
  ...
  { id: "feud", icon: "🗡️", name: "A Blood-Feud", domainCalm: true,
    ...
    a: { label: "Mediate a settlement (−8 grain, −2 cattle)", cost: { grain: 8, cattle: 2 }, gain: {}, calm: 4, log: "Gifts and patient words knit the feud closed." },
  ...
  { id: "vein", icon: "⛏️", name: "A Rich Clay-Vein", domain: "forge",
    ...
    a: { label: "Work it hard (−6 timber to shore it up)", cost: { timber: 6 }, gain: { clay: 26, ergon: 10 }, log: "Shored and worked, the vein yields a fortune in clay." },
  ...
  { id: "bard", icon: "🎶", name: "A Famous Aoidos Passes Through",
    ...
    a: { label: "Feast him richly (−6 grapes, −4 cattle)", cost: { grapes: 6, cattle: 4 }, gain: { kleos: 10, muthos: 12 }, log: "The aoidos sings your deeds in far halls; renown and lore swell." },
  ...
  { id: "comet", icon: "☄️", name: "An Omen in the Sky", domain: "sky",
    ...
    a: { label: "Proclaim it a blessing (−6 piety to lead rites)", cost: { piety: 6 }, gain: { muthos: 10 }, calm: 3, log: "Declared a blessing, the omen becomes a festival; fear turns to wonder." },
...
export const GOD_EVENTS = [
  { id: "demand", icon: "🔥", name: "A God's Demand",
    ...
    a: { label: "Lay the great offering (−4 cattle, −8 grain)", cost: { cattle: 4, grain: 8 }, happy: 14, log: g => `The altar of ${godName(g)} runs red; the god is well pleased.` },
  ...
  { id: "rival", icon: "🌀", name: "A Rival Cult",
    ...
    a: { label: "Outshine them with festival (−8 grapes, −6 piety)", cost: { grapes: 8, piety: 6 }, happy: 10, log: g => `A dazzling festival wins the people back to ${godName(g)}.` },
  ...
  { id: "quarrel", icon: "🗣️", name: "A Quarrel in the Priesthood",
    ...
    a: { label: "Buy peace with gifts (−10 grain, −2 cattle)", cost: { grain: 10, cattle: 2 }, happy: 8, log: g => `The priests of ${godName(g)} are reconciled, and the rites restored.` },
